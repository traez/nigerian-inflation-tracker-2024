  ...
  return (
    <li key={entry.id} className="p-4 bg-white rounded-lg shadow">
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-sm text-gray-500">Price: <span>&#8358;</span>{entry.price.toFixed(2)}</p>
      ...
      <button onClick={handleEdit} className="text-blue-600 hover:text-blue-800 mt-2 mr-2">
        Edit
      </button>
